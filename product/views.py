...
from .serializers import CategorySerializer, CategoryValueSerializer, ReviewSerializer, ReviewValidateSerializer, \
...
class ProductRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        serializer = ProductValidateSerializer(instance, data=request.data, partial=partial)
        serializer.is_valid(raise_exception=True)
        ...
        category_id = serializer.validated_data.get('category', instance.category_id)
        tags = serializer.validated_data.get('tags', instance.tags.values_list('id', flat=True))
...
class ReviewRetrieveUpdateDestroyAPIView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def update(self, request, *args, **kwargs):
        partial = kwargs.pop('partial', False)
        instance = self.get_object()
        serializer = ReviewValidateSerializer(instance, data=request.data, partial=partial)
        serializer.is_valid(raise_exception=True)
        ...
        stars = serializer.validated_data.get('stars', instance.stars)
        ...
        return Response(data=ReviewSerializer(instance).data, status=status.HTTP_200_OK)
